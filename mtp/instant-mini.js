...
function mtp() {
   ...
   // fill holes left by possible blank track titles
    ...
    xplay.onmouseover = function() { this.style.opacity = "0.55"; };
    ...
    xpause.onmouseover = function() { this.style.opacity = "0.55"; };
    ...
    xskip.onmouseover = function() { this.style.opacity = "0.55"; };
